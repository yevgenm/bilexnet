    ...
    with open(fn) as f:
        ...
        for row in test_reader:
            ...
            for cond_idx in range(n_conds):
                ...
                target_responses = [(cue+extras["language mapping"][cue_lang], preprocess_word(responses_mixed[r_idx])+extras["language mapping"][target_lang]) for r_idx in range(len(responses_mixed))
